...
public class ClientPacketHandler {
     ...
     * @param responseSender
     */
    private void noteblockEntityPlayUpdate(MinecraftClient client, ClientPlayNetworkHandler handler,
        ...
        client.execute(() -> {
            ...
            EntityTrackingSoundInstance noteInstance = new EntityTrackingSoundInstance( // track the entity, play the
                    ...
                    (float) Math.pow(2.0, (double) (note - 12) / 12.0), entity, client.world.getRandom().nextLong());
